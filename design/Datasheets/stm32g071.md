...
depends on the number of supply pins in the device (3 parts x (n+1) supply pins). This test
...
PI/O = Σ (VOL x IOL) + Σ ((VDDIO1 - VOH) x IOH),
...
PINT = 50 mA x 3.6 V= 118 mW,
the power loss through I/Os PIO is
PIO = 20 x 8 mA x 0.4 V + 8 x 20 mA x 1.3 V = 272 mW,
...
TJ = 50°C + (65 °C/W x 452 mW) = 50 °C + 29.4 °C = 79.4 °C
ΘJC
Thermal resistance
junction-board
WLCSP25 5
