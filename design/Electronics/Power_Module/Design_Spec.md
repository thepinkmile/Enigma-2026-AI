...
| U17 | Single AND gate SOT-23-5 | SN74LVC1G08DBVR | Texas Instruments | 296-11601-1-ND | 595-SN74LVC1G08DBVR | C7666 | - | Single 2-input positive AND gate, 1.65-5.5V supply, push-pull output, 5.5V-tolerant inputs. Gates the U9 1Hz oscillator into the SW2 red sink while the shutdown latch is set. VCC bypass: C44 (100nF). | Yes | Pending | 1 |
