...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 5V_USB (J1 C4R1 → FT232H VCC) | ≤ 120 mA peak | 0.02 mm | per GRS §1.1 | **per GRS §1.1** | L1 + L3 pour | FT232H datasheet Table 5.2 (p.41): Ireg ≈ 54 mA + Iccphy ≈ 60 mA = 114 mA absolute max, rounded up to 120 mA for margin. Note: a legacy figure of 400 mA was ≈4× the actual device maximum and has been corrected. Power-rail minimum applies. |
| 3V3_ENIG (J1 C7R1 → FT232H VCCIO) | 15 mA | 0.002 mm | per GRS §1.1 | **per GRS §1.1** | L1 + L3 pour | VCCIO domain; 3V3_ENIG canonical width per GRS §1.1 |
| JTAG signals: TCK, TMS, TDI, TDO (CI) | signal | - | per GRS §2.3.2 | **per GRS §2.3.2 / JLCPCB_Manufacturing.md §1.1** | L2 (inner) | JM inverted stackup (DEC-017): L2 buried microstrip immediately below L1 GND plane. 50 Ω controlled impedance per GRS §2.3.2 and JLCPCB_Manufacturing.md §1.1. Per DEC-016. |
